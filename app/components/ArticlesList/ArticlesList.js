...
const ArticlesList = () => {
    ...
    return (
        <>
            {isLoading ? <Loader/> : <div className="text-center w-1/2 p-6" style={{borderRightWidth: "1px"}}>
                {articles?.length ?
                            ...
                            <div className="flex justify-evenly mr-8 mb-6 ">
                                <div className="block p-6 rounded-lg shadow-lg bg-white w-60">
                                    ...
                                    <Link href={`/article/${article.articleId}`}>
                                        <button type="button"
                                                className=" inline-block px-6 py-2.5 bg-blue-600 text-white font-medium text-xs leading-tight  rounded shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out">Подробнее
                                        </button>
                                    </Link>
                                </div>
                            </div>
